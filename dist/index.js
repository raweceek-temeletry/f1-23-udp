...
var F123UDP = /** @class */ (function (_super) {
    __extends(F123UDP, _super);
    function F123UDP(options) {
        if (options === void 0) { options = {}; }
        var _this = _super.call(this) || this;
        var _a = options.port, port = _a === void 0 ? DEFAULT_PORT : _a, _b = options.address, address = _b === void 0 ? ADDRESS : _b;
        _this.port = port;
    ...
    F123UDP.prototype.stop = function () {
        this.socket.close();
    };
    return F123UDP;
}(node_stream_1.EventEmitter));
exports.F123UDP = F123UDP;
